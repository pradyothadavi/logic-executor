...
public class LogicException extends RuntimeException {
    ...
    public boolean isTerminateFurtherExecution() {
        return terminateFurtherExecution;
    }

    public void setTerminateFurtherExecution(boolean terminateFurtherExecution) {
        this.terminateFurtherExecution = terminateFurtherExecution;
    }
}
